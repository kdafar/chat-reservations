...
META = {
    ...
    '02-reception-front-desk': dict(role='reception',
        ...
        desc_en='Add a patient who is here now, book a patient for another day, and check in patients who booked — including offers.',
        desc_ar='إضافة مريض حاضر الآن، حجز مريض ليوم آخر، وتسجيل وصول من حجز مسبقاً — بما في ذلك العروض.',
        steps_en=['Add patient → Here now', 'Find the patient and the doctor', 'Book a time for another day', 'Check in a booking', 'Approve an offer from another branch'],
        steps_ar=['إضافة مريض ← موجود الآن', 'اختيار المريض والطبيب', 'حجز موعد ليوم آخر', 'تسجيل وصول صاحب حجز', 'اعتماد عرض من فرع آخر']),
    ...
    '06-reception-payment-close': dict(role='reception',
        ...
        desc_en='Take a payment, discharge with the checklist, apply insurance, read the visit timeline, and close the cash drawer.',
        desc_ar='استلام دفعة، الخروج بقائمة التحقق، تطبيق التأمين، قراءة سجل الزيارة، وإغلاق الصندوق.',
        steps_en=['Take a payment', 'Discharge a paid visit', 'Unpaid and insurance warnings', 'Apply the insurer’s share', 'The visit timeline', 'Daily cash close'],
        steps_ar=['استلام دفعة', 'خروج زيارة مدفوعة', 'تنبيهات عدم الدفع والتأمين', 'تطبيق حصة التأمين', 'سجل مجريات الزيارة', 'إغلاق الصندوق اليومي']),
