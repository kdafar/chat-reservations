...
const t = computed(() => isRtl.value ? {
    title: 'الحملات', eyebrow: 'منصة واتساب', desc: 'حملات البث الجماعي.', new: 'حملة جديدة', edit: 'تعديل', del: 'حذف', send: 'إرسال الآن', addR: 'إضافة مستلم', import: 'استيراد CSV', analytics: 'التحليلات', fromGroup: 'من مجموعة', pickGroup: 'اختر مجموعة', add: 'إضافة',
    ...
    title: 'Campaigns', eyebrow: 'WhatsApp Platform', desc: 'Bulk broadcast campaigns.', new: 'New campaign', edit: 'Edit', del: 'Delete', send: 'Send now', addR: 'Add recipient', import: 'Import CSV', analytics: 'Analytics', fromGroup: 'Add from group', pickGroup: 'Pick a group', add: 'Add',
