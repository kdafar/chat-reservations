...
function archive(row) {
    confirm({ body: t.value.deleteConfirm, tone: 'destructive', onConfirm: () => {
    ...
    <div style="padding:24px; max-width:1280px; margin:0 auto;">
        <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:16px; margin-bottom:16px;">
            ...
            <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
                ...
                <Link class="btn btn-primary" :href="route('v2.accounting.vendors.create')"><Icon name="plus" :size="14" /><span>{{ t.new }}</span></Link>
            </div>
        </div>
        ...
        <div class="card" style="overflow:hidden;">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr v-for="row in page.data" :key="row.id" @click="router.visit(route('v2.accounting.vendors.edit', { vendor: row.id }))" style="cursor:pointer;">
