...
@section('title', __('error.502.title'))
@section('content')
<div class="min-h-[60vh] grid place-items-center px-4 sm:px-6 lg:px-8">
  <div class="w-full max-w-xl text-center">
    ...
    <h1 class="mt-4 text-2xl font-bold text-gray-900">502 — {{ __('error.502.title') }}</h1>
    <p class="mt-2 text-gray-600">{{ __('error.502.desc') }}</p>
