...
return [
    ...
    'clinic_item' => [
        'sections' => [
            ...
            'bom' => 'المستهلكات المستخدمة (قائمة المكوّنات)',
            'bom_description' => 'أصناف تُخصم من المخزون في كل مرة تُؤدّى فيها هذه الخدمة في زيارة.',
        ],
        'bom' => [
            'add' => 'إضافة مستهلك',
            'item' => 'الصنف',
            ...
            'is_optional' => 'اختياري',
            'is_optional_help' => 'مُدرج لكن لا يُخصم تلقائيًا — يضيفه الطبيب يدويًا عند استخدامه.',
        ],
        'fields' => [
            'branch' => 'الفرع',
            'type' => 'النوع',
