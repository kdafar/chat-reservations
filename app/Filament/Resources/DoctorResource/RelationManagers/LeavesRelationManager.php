            ...
            ->headerActions([
                Tables\Actions\CreateAction::make()
                    ->mutateFormDataUsing(function (array $data): array {
                        ...
                        // Doctors must have a linked User to request leave via this tab.
                        $data['user_id'] = $doctor->user_id ?? (int) (auth()->id() ?? 0);
                    ...
                    ->before(function (Tables\Actions\CreateAction $action) {
                        ...
                        if (! $doctor->user_id) {
                            Notification::make()
                                ->title('Doctor has no linked user account')
                                ->body('Create a User for this doctor in the Users tab before requesting leave from here.')
